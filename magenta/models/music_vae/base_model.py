...
from official.transformer.transformer_main import define_transformer_flags, get_params, logger, flags


class MusicVAETransformer(object):
  """Music Variational Autoencoder with Transformer core."""

  def __init__(self):
    """Initializer for a MusicVAETransformer model.
    """
    # the decoder and the encoder is no more passed in, but created inline
  ...
  def _compute_model_loss(
    ...
    logits = self.transformer.call_reconstruction_loss(
      x_input, x_target, x_length, z, control_sequence)[0:2]
  ...
  def sample(self, n, max_length=None, z=None, c_input=None, **kwargs):
    ...
    return self.transformer.call_sample(n, max_length, z, c_input, **kwargs)
